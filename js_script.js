...
let orders = [
    {
        ...
        date: "2023-10-15",
        products: "سماعات الرأس النييون، ماوس الألعاب",
        amount: 100,
        status: "new",
...
// تحسين التجربة على الهواتف
function initMobileOptimizations() {
    // منع الزوم عند النقر المزدوج على الهاتف
    let lastTouchEnd = 0;
    ...
    // منع التمرير عند فتح السلة أو النماذج
    document.addEventListener('DOMContentLoaded', function() {
...
// استدعاء الدالة في بداية تحميل الصفحة
document.addEventListener('DOMContentLoaded', function() {
    initMobileOptimizations();
    
    // إضافة دعم لللمسات الطويلة (Long press)
    document.querySelectorAll('.product-card').forEach(card => {
        ...
        card.addEventListener('touchstart', function(e) {
            pressTimer = setTimeout(() => {
                ...
                this.style.boxShadow = '0 5px 15px rgba(157, 78, 221, 0.5)';
            }, 500);
        });
